...
|------|-------------|------|---------|:--------:|
| <a name="input_aws_account_id"></a> [aws\_account\_id](#input\_aws\_account\_id) | AWS account hosting the BRANCH infrastructure; published as vars.AWS\_ACCOUNT\_ID | `string` | `"404813129370"` | no |
