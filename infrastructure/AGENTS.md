...
- `main.tf` — repo settings (squash-only, auto-merge, delete-branch-on-merge, merge queue, vuln alerts), main branch protection (required checks: `terraform-plan-summary`, `lambda-tests`, `frontend-ci`; 1 code-owner approval), collaborators.
